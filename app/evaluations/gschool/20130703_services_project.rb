instructor_evaluation "Services Project" do
  section "Services" do
    description "
    <ul>
      <li>4: All major services are separated out into independent services</li>
      <li>3: One major service is coupled with another service</li>
      <li>2: Two major service is coupled with another service</li>
      <li>1: Three major service is coupled with another service</li>
      <li>0: All major service is coupled together</li>
    </ul>"
  ...
  section "VPS" do
    description "
    <ul>
      <li>4: Services are deployed and running on a VPS and manageable through Capistrano</li>
      <li>2: Services are deployed and running on a VPS</li>
      <li>0: Services are not deployed and running on a VPS</li>
    </ul>"
    free_response "What score did they earn? (0-4)", :kind => :integer, :group => :overall_score, :range => 0..4
    free_response "If applicable, what problems did you run into?", :kind => :text
  end
